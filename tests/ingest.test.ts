	...
	return {
		...
		properties: {
			Name: {
				...
				type: "title",
				title: [
					{ type: "text", plain_text: "My Page", href: null, annotations: { bold: false, italic: false, strikethrough: false, underline: false, code: false, color: "default" } },
				],
			},
		},
	};
...
function paragraph(id: string, text: string) {
	return {
		...
		paragraph: {
			rich_text: [
				{ type: "text", plain_text: text, href: null, annotations: { bold: false, italic: false, strikethrough: false, underline: false, code: false, color: "default" } },
			],
		},
	};
}
...
describe("ingestPage", () => {
	...
	it("Notion ページを取得して content.create し、syncMap に記録する", async () => {
		...
		const body = t.created[0]!.data.body as Array<{ _type: string; children?: Array<{ text: string }> }>;
